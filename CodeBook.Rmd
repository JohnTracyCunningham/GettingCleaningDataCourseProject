...
4 and 5. To replace the activity numbers in "y" with descriptive text, the activities data frame was reduced to lower case.  Underscores were retained.  Then the substitution was performed, resulting in a "y" data frame with only descriptive activity text.
